 ...
 */
public class SimpleBuffered extends FullScreenFrame3
{
	/**
	 ...
	 */
	public SimpleBuffered(String title, DisplayMode mode) throws HeadlessException
	{
		super(title,mode);
		loadImage();
	}
	 ...
	 * @throws java.awt.HeadlessException
	 */
	public SimpleBuffered(String title, boolean undecorated) throws HeadlessException
	{
    ...
    public static void main(String[] args)
    {
		...
		SimpleBuffered myFrame = null;
			
		if(fullScreenMode && !forceWindowedMode)
			myFrame = new SimpleBuffered("SimpleBuffered Full Screen Mode", newMode);
		else
			myFrame = new SimpleBuffered("SimpleBuffered Windowed Mode", false);
